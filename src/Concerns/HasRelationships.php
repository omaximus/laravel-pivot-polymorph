...
trait HasRelationships
{
    ...
    /**
     * Define fully reciprocal relation with specified related model
     *
     * @param string $related
     * @param string $name
     * @param string $relatedName
     ...
     * @param null $relatedKey
     *
     * @return \Pisochek\PivotPolymorph\Relations\ReciprocalToMany
     */
    public function ReciprocalMany(
        $related,
        $name,
        $relatedName,
        $table,
